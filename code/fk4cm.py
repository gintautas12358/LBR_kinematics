...
def fk4cm(qpos):
	...
	x = (0.067*sin(tt1)*sin(tt3) - 0.067*cos(tt1)*cos(tt2)*cos(tt3))*sin(tt4) + 0.034*sin(tt1)*cos(tt3) + 0.067*sin(tt2)*cos(tt1)*cos(tt4) + 0.42*sin(tt2)*cos(tt1) + 0.034*sin(tt3)*cos(tt1)*cos(tt2)
	y = (-0.067*sin(tt1)*cos(tt2)*cos(tt3) - 0.067*sin(tt3)*cos(tt1))*sin(tt4) + 0.067*sin(tt1)*sin(tt2)*cos(tt4) + 0.42*sin(tt1)*sin(tt2) + 0.034*sin(tt1)*sin(tt3)*cos(tt2) - 0.034*cos(tt1)*cos(tt3)
