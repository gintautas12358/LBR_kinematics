...
def fk5(qpos):
	...
	x = (0.1845*sin(tt1)*sin(tt3) - 0.1845*cos(tt1)*cos(tt2)*cos(tt3))*sin(tt4) + 0.1845*sin(tt2)*cos(tt1)*cos(tt4) + 0.42*sin(tt2)*cos(tt1)
	y = (-0.1845*sin(tt1)*cos(tt2)*cos(tt3) - 0.1845*sin(tt3)*cos(tt1))*sin(tt4) + 0.1845*sin(tt1)*sin(tt2)*cos(tt4) + 0.42*sin(tt1)*sin(tt2)
